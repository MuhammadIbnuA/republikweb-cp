...
// attendance
app.post('/generate-attendance', attendanceController.generateAttendanceData);
...
app.get('/activitylog/date/:date', authenticateToken, activityLogController.getActivityLogsByDate);
